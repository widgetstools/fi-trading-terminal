          ...
          <div style={{flex:1}}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={DURATION_BUCKETS} margin={{top:16,right:16,bottom:8,left:8}}>
                ...
                <Tooltip content={<TT/>}/>
                <Bar yAxisId="l" dataKey="count" name="# Bonds" fill="#c9cdd4" fillOpacity={0.7} radius={[2,2,0,0]}/>
                <Bar yAxisId="r" dataKey="dv01" name="DV01" fill="#e1e4ea" fillOpacity={0.5} radius={[2,2,0,0]}/>
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div style={{flex:1}}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={HIST_OAS} margin={{top:12,right:16,bottom:8,left:8}}>
                ...
                <Tooltip content={<TT/>}/>
                <Line yAxisId="ig" type="monotone" dataKey="ig" name="CDX IG" stroke="#c9cdd4" strokeWidth={1.5} dot={false}/>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={[{attr:'Carry',pnl:+188},{attr:'Spread Δ',pnl:+142},{attr:'Rate Δ',pnl:+88},{attr:'FX',pnl:-22},{attr:'Costs',pnl:-34},{attr:'Total',pnl:+362}]} margin={{top:12,right:16,bottom:8,left:8}}>
                ...
                <Bar dataKey="pnl" name="P&L ($K)" radius={[2,2,0,0]}>
                  {[+188,+142,+88,-22,-34,+362].map((v,i)=><Cell key={i} fill={v>=0?'#c9cdd4':'var(--bn-red)'} fillOpacity={i===5?1:0.75}/>)}
                </Bar>
              </BarChart>
            </ResponsiveContainer>
          </div>
