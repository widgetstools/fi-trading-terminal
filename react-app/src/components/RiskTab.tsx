...
const HEAT_COLORS = ['#42b0df','#e9c230','#ec8039','#b65420','#db3880','#b51f60'];
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={DV01_DATA} margin={{top:12,right:16,bottom:8,left:8}}>
                    ...
                    <Bar dataKey="dv01" name="DV01" radius={[2,2,0,0]}>
                      {DV01_DATA.map((_,i)=><Cell key={i} fill={['#42b0df','#db3880','#42b0df','#e9c230','#9b7fc5'][i%5]}/>)}
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={SCENARIO_DATA} margin={{top:12,right:16,bottom:8,left:8}}>
                    ...
                    <Bar dataKey="total" name="Total P&L" radius={[2,2,0,0]}>
                      {SCENARIO_DATA.map((d,i)=><Cell key={i} fill={d.total>=0?'#42b0df':'#db3880'}/>)}
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
            ...
            <div style={{flex:1}}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={VAR_DATA} margin={{top:8,right:16,bottom:4,left:8}}>
                  ...
                  <Tooltip content={<TT/>}/>
                  <Line type="monotone" dataKey="var" name="VaR 95%" stroke="#ec8039" strokeWidth={1.5} dot={false}/>
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
