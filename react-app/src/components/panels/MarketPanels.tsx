      ...
      <div style={{flex:1}}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={series} margin={{top:4,right:16,bottom:8,left:8}}>
            <defs><linearGradient id="ig" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#e32636" stopOpacity={0.15}/><stop offset="95%" stopColor="#e32636" stopOpacity={0}/></linearGradient></defs>
