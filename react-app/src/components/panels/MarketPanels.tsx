      ...
      <div style={{flex:1}}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={series} margin={{top:4,right:16,bottom:8,left:8}}>
            <defs><linearGradient id="ig" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#42b0df" stopOpacity={0.15}/><stop offset="95%" stopColor="#42b0df" stopOpacity={0}/></linearGradient></defs>
            ...
            <Tooltip content={<TT/>}/>
            <Area type="monotone" dataKey="v" name={selected} stroke="#42b0df" strokeWidth={1.8} fill="url(#ig)" dot={false} activeDot={{r:3}}/>
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
      ...
      <div style={{flex:1}}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={YC_CHART_DATA} margin={{top:12,right:16,bottom:8,left:8}}>
            ...
            <Tooltip content={<TT/>}/>
            <Line type="monotone" dataKey="today" name="Today" stroke="#42b0df" strokeWidth={2} dot={{r:2.5,fill:'#42b0df'}}/>
