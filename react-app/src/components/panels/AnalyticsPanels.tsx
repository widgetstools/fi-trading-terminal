...
const RTG_COLOR: Record<string, string> = { aaa: '#c9cdd4', aa: '#e1e4ea', a: '#00a676', bbb: '#ff6b35', hy: '#e32636' };
...
const SECTOR_COLORS = ['#c9cdd4', '#e1e4ea', '#8b5cf6', '#00a676', '#ff6b35', '#d15427'];
      ...
      <div style={{ flex: 1 }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={BUCKET_DATA} margin={{ top: 12, right: 16, bottom: 4, left: 4 }}>
            ...
            <Tooltip content={<TT />} />
            <Bar yAxisId="dv01" dataKey="dv01" name="DV01" fill="#c9cdd4" radius={[3, 3, 0, 0]} barSize={18} fillOpacity={0.8} />
      ...
      <div style={{ flex: 1 }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={HIST_OAS} margin={{ top: 4, right: 16, bottom: 8, left: 8 }}>
            <defs>
              <linearGradient id="igGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#c9cdd4" stopOpacity={0.15} /><stop offset="95%" stopColor="#c9cdd4" stopOpacity={0} /></linearGradient>
            ...
            <Tooltip content={<TT />} />
            <Area yAxisId="ig" type="monotone" dataKey="ig" name="CDX IG" stroke="#c9cdd4" strokeWidth={1.5} fill="url(#igGrad)" dot={false} />
            ...
            <Tooltip content={(props: any) => {
              ...
              return (
                <div style={{ background: 'var(--bn-bg2)', border: BD, borderRadius: 3, padding: '6px 10px', fontFamily: 'JetBrains Mono,monospace', fontSize: 11 }}>
                  ...
                  <div style={{ color: d.payload.color || '#c9cdd4' }}>OAS: +{d.value}bp</div>
                </div>
              );
            }} />
...
export function PnlAttribution() {
  const chartData = [
    ...PNL_DATA.map(d => ({ ...d, fill: d.pnl >= 0 ? '#c9cdd4' : 'var(--bn-red)' })),
            ...
            <Tooltip content={(props: any) => {
              ...
              return (
                <div style={{ background: 'var(--bn-bg2)', border: BD, borderRadius: 3, padding: '6px 10px', fontFamily: 'JetBrains Mono,monospace', fontSize: 11 }}>
                  ...
                  <div style={{ color: isPos ? '#c9cdd4' : 'var(--bn-red)', fontWeight: 600 }}>{isPos ? '+' : ''}${d.value}K</div>
                </div>
              );
            }} />
