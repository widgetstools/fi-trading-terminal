    ...
    >
      ...
      <div style="flex:1;overflow-y:auto;padding:24px">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:6px">
          <span
            style="font-size:18px;font-weight:700;color:#e9c230;font-family:JetBrains Mono,monospace"
            >{{ note.ticker }}</span
          >
          <span
        ...
        >
          ...
          >
            ...
            <div
              style="font-size:18px;font-weight:700;color:#ec8039;font-family:JetBrains Mono,monospace"
            >
              +{{ note.prev }}bp
            </div>
          </div>
