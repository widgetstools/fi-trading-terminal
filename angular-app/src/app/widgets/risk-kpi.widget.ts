...
export class RiskKpiWidget {
  ...
  @Input() panel: any;
  kpis = [
    { label: 'Portfolio DV01', val: '$18,420', sub: 'per bp', color: '#42b0df' },
    { label: 'Total MV', val: '$54.2M', sub: 'MTD +$1.4M', color: '#42b0df' },
    { label: 'VaR 95% 1D', val: '-$248K', sub: 'within limit', color: '#ec8039' },
    { label: 'OAS Duration', val: '4.82 yrs', sub: 'mod duration', color: '#e9c230' },
    { label: 'Spread PnL MTD', val: '+$142K', sub: 'vs bench +38K', color: 'var(--bn-green)' },
    { label: 'Credit Delta', val: '$8,240', sub: 'IG/HY blended', color: '#9b7fc5' },
  ];
}
