...
const BADGE_STYLES: Record<QuoteType, { bg: string; color: string }> = {
  STREAM: { bg: 'rgba(168,210,41,0.12)', color: 'var(--bn-green)' },
  RFQ: { bg: 'rgba(66,176,223,0.12)', color: 'var(--bn-blue)' },
  IND: { bg: 'rgba(236,128,57,0.12)', color: 'var(--bn-amber)' },
};
  ...
  template: `
    <div style="display:flex;flex-direction:column;height:100%;background:var(--bn-bg1)">
      ...
      >
        ...
        <div style="margin-left:auto;display:flex;align-items:center;gap:12px">
          ...
          <span class="font-mono-fi" style="font-size:9px">
            ...
            <span style="color:#42b0df;font-weight:600">{{ bond.dur }}</span>
          </span>
        </div>
      </div>
      ...
      <div style="flex:1;overflow:hidden;display:flex;flex-direction:column;min-height:0">
        ...
        >
          <div style="margin-top:auto">
            ...
            >
              ...
              <div class="font-mono-fi" style="font-size:11px;color:#42b0df;text-align:right">
                {{ a.dv01.toFixed(1) }}
              </div>
        ...
        <div
          *ngIf="view === 'both'"
          style="display:flex;align-items:center;padding:6px 12px;border-top:1px solid var(--bn-border);border-bottom:1px solid var(--bn-border);flex-shrink:0;background:linear-gradient(90deg, rgba(168,210,41,0.08), var(--bn-bg2), rgba(219,56,128,0.08))"
        >
          ...
          <div style="margin-left:auto;display:flex;align-items:center;gap:16px">
            ...
            <span class="font-mono-fi" style="font-size:9px">
              ...
              <span style="color:#e9c230;font-weight:600">{{ bond.ytm.toFixed(3) }}</span>
            </span>
            <span class="font-mono-fi" style="font-size:9px">
              <span style="color:var(--bn-t2)">Z-Spd </span>
              <span style="color:#9b7fc5;font-weight:600">{{ bond.gSpd }}</span>
            </span>
