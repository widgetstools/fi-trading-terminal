...
export const OAS_DATA = [
  { name: 'UST 4.625', oas: 0, color: '#42b0df' },
  { name: 'MSFT 2.40', oas: 22, color: '#42b0df' },
  { name: 'AAPL 2.05', oas: 18, color: '#42b0df' },
  { name: 'JNJ 3.40', oas: 48, color: '#e9c230' },
  { name: 'PG 3.00', oas: 52, color: '#e9c230' },
  { name: 'JPM 4.50', oas: 58, color: '#e9c230' },
  { name: 'MSFT 3.45', oas: 85, color: '#ec8039' },
  { name: 'AAPL 4.10', oas: 132, color: '#ec8039' },
  { name: 'JPM 5.04', oas: 98, color: '#ec8039' },
  { name: 'JPM 5.35', oas: 125, color: '#db3880' },
];
