...
const STATUS_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  Filled:    { bg: 'rgba(168,210,41,0.12)',  color: 'var(--bn-green)',  border: 'rgba(168,210,41,0.3)' },
  Partial:   { bg: 'rgba(236,128,57,0.12)',  color: 'var(--bn-amber)', border: 'rgba(236,128,57,0.3)' },
  Pending:   { bg: 'rgba(66,176,223,0.12)',  color: 'var(--bn-blue)',   border: 'rgba(66,176,223,0.3)' },
  Cancelled: { bg: 'rgba(219,56,128,0.10)', color: 'var(--bn-red)',    border: 'rgba(219,56,128,0.3)' },
  Working:   { bg: 'rgba(66,176,223,0.12)',  color: 'var(--bn-blue)',   border: 'rgba(66,176,223,0.3)' },
};
...
const RTG_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  aaa: { bg: 'rgba(168,210,41,0.1)',   color: 'var(--bn-green)',  border: 'rgba(168,210,41,0.25)' },
  aa:  { bg: 'rgba(168,210,41,0.06)',  color: 'var(--bn-green)',  border: 'rgba(168,210,41,0.2)' },
  a:   { bg: 'rgba(190,242,100,0.08)', color: '#a8d229',          border: 'rgba(132,204,22,0.25)' },
  bbb: { bg: 'rgba(236,128,57,0.08)',  color: 'var(--bn-amber)', border: 'rgba(236,128,57,0.25)' },
  hy:  { bg: 'rgba(219,56,128,0.08)', color: 'var(--bn-red)',    border: 'rgba(219,56,128,0.25)' },
};
...
const RFQ_STATUS_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  live:  { bg: 'rgba(66,176,223,0.1)',  color: 'var(--bn-blue)',  border: 'rgba(66,176,223,0.25)' },
  done:  { bg: 'rgba(168,210,41,0.12)', color: 'var(--bn-green)', border: 'rgba(168,210,41,0.25)' },
